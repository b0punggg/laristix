...
export const apiPaths = {
  ...
  events: {
    ...
    promoCodes: (uuid: string) => `/api/v1/events/${uuid}/promo-codes`,
    withdrawals: (uuid: string) => `/api/v1/events/${uuid}/withdrawals`,
  ...
  admin: {
    ...
    withdrawal: (uuid: string) => `/api/v1/admin/withdrawals/${uuid}`,
    withdrawalDocuments: (uuid: string) => `/api/v1/admin/withdrawals/${uuid}/documents`,
