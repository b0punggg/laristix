...
function TableToolbar({ className, title, description, children, ...props }: TableToolbarProps) {
  return (
    <div className={cn("mb-4 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between", className)} {...props}>
      <div>
        {title ? <h3 className="ds-heading-4">{title}</h3> : null}
...
export { Table, TableHeader, TableBody, TableFooter, TableHead, TableRow, TableCell, TableCaption, TableToolbar };
