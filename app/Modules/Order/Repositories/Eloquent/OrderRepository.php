...
class OrderRepository implements OrderRepositoryInterface
{
    public function findByUuid(string $uuid): ?Order
    {
        return Order::withoutOrganizerScope()
            ->with(['items.ticketType', 'payment', 'registrations.ticket', 'registrations.orderItem', 'event.venue', 'event.category', 'organizer'])
            ->where('uuid', $uuid)
            ->first();
    }
    ...
    {
        return Order::withoutOrganizerScope()
            ->with(['items', 'payment', 'registrations.ticket', 'registrations.orderItem', 'event.venue', 'event.category'])
